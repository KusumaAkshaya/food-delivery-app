        ...
        <div className="p-6 bg-gray-50 h-full">
            ...
            {cart.length === 0 ? (
                <div className="flex flex-col items-center h-screen m-auto" >
                    ...
                    <button><Link href='/search' >Go to Search</Link></button>
                </div>
            ) : (
                <section className="flex flex-col" >
                    <div className="lg:w-1/3 md:w-1/2 min-w-90 m-2 border-2 py-5 px-2 rounded-sm border-gray-500 bg-white shadow-md">
                        ...
                        <div className="bg-white border-2 border-gray-500 mt-2" >
